...
module.exports = function () {
  return `SELECT DISTINCT ?house ?ordinal ?item ?itemLabel
  ...
  WHERE {
    VALUES ?house { wd:Q4902948 wd:Q2993867 wd:Q1969569 }
    ?item p:P31 ?isa .
    ?isa ps:P31 wd:Q15238777 ; pq:P642 ?house .
